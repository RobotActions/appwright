...
somewhere the grid can download it, and configure the provider in your config. Test names and
pass/fail land on the grid dashboard, and each session's recording is attached to the Playwright
report.
